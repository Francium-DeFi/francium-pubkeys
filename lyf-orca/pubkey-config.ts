...
export const ORCA_USER_FARM_INFO_ACCOUNT_LAYOUT = {}
export const lyfPubkeyConfig =  {
    'SOL-USDC': {
        ...
        strategyRewardsSwapTargetAccount: new PublicKey('FfrdqDdCBgaUt2CgZ6KrFnmWH95585FATMLAgy1H3Pi4'),
        ...
        lendingPoolConfig: {
            ...
            "0": {
                tknMint: tokens["usdcToken"].mint, // usdc
            ...
            "1":{
                tknMint:  tokens["solToken"].mint, // wsol
        ...
        ammInfo: {
            ...
            stakePoolRewardsMint: tokens["orcaToken"].mint,
    ...
    'ORCA-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["orcaToken"].mint,
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey("HBc25ZyXiGMERxUX2KupZjc3DAivA48wBSgZGxCQgtT6"),
    ...
    'ATLAS-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["atlasToken"].mint,
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["atlasToken"].mint,
    ...
    'POLIS-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["polisToken"].mint,
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["polisToken"].mint,
    ...
    //     tknMint1:  tokens["solToken"].mint,
    //
    //     strategyAccount: new PublicKey('6R9ZYsFqr5PBuKAFP2nFgQLxiFGurQbLVtToa6KinJeG'),
    //     strategyAuthority: new PublicKey('GfAmFyjeVJjGmM5HnVXYDrWuBbkSi3G2HsVYjoyvUAmo'),
    //     strategyFarmInfo: new PublicKey('BoVR5uRxYx9tgAtTPtuUU6givAULithwSsbRCrwMEaet'),
    //     strategyTknAccount0: new PublicKey('2sj4gT24vRcEk4Ax7AQu6DKBPZ7Jr87heBWXxpaDup43'),
    //     strategyTknAccount1: new PublicKey('BSiBwfeTJvhp5E6SXGYnzJEMYCgCw4eDdfp1taX2H3BU'),
    //     strategyLpTknAccount: new PublicKey('KFifX66Zkyb9nTGw7DPQT5wNEhxrPCdrUykLLCxKuDt'),
    //     strategyRewardTknAccount: new PublicKey('3VcxppYH626tdnDZ9PW386zfRpSFMXNnEdbkZwFN2y92'),
    //     strategyFarmTknAccount: new PublicKey('6Yp2iS5dBLAHTNMoZ4dM5e26t4fHmMZpH3gbokZzZgXA'),
    //     strategyBorrowCreditAccount0: new PublicKey('HVuNjCPg6FBXAprsoaaSVRRoTeVZAXQfYNNz5LGQWXXi'),
    //     strategyBorrowCreditAccount1: new PublicKey('EPCfvg5i6QK6eo1eVNZ6Q6Ld352u5Gx6Dw673W5sq6ws'),
    //     doubleDipStrategyFarmTknAccount: undefined,
    //     doubleDipStrategyRewardTknAccount: undefined,
    //     doubleDipStrategyFarmInfo: undefined,
    //
    //     strategyRewardsSwapTargetAccount: new PublicKey('BSiBwfeTJvhp5E6SXGYnzJEMYCgCw4eDdfp1taX2H3BU'),
    //
    //     lendingPoolConfig: {
    //         programId: new PublicKey("FC81tbGt6JWRXidaWYFXxGnTk4VgobhJHATvTRVMqgWj"),
    //         marketInfoAccount: new PublicKey("4XNif294wbrxj6tJ8K5Rg7SuaEACnu9s2L27i28MQB6E"),
    ...
    'mSOL-USDC': {
        ...
        ammInfo: {
            ...
            doubleDipPool:  {
                rewardTknMint: tokens["mariandeToken"].mint,
    ...
    'ORCA-mSOL':  {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["msolToken"].mint,
        tknMint1: tokens["orcaToken"].mint,
    ...
    'NINJA-SOL':  {
        ...
        programId: lyfOrcaProgramId,
        tknMint0:  tokens["solToken"].mint,
        tknMint1: tokens["ninjaToken"].mint,
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey('C8KCqgSQbQY36wSd2K86DLe96SZsBD6P93ep3uBiShKC'),
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["ninjaToken"].mint,
    ...
    'SBR-USDC': {
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey('4VftiTxhqkSQS7u41waZzEsqdVkDJ8RLaHVM9znprb7s'),
    ...
    'LIQ-USDC': {
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey("ByziT8rK1wCj8GA7BRkkSc5mc4hicikDU8KGJUvENqYZ"),
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["liqToken"].mint,
    ...
    'COPE-USDC': {
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["copeToken"].mint,
    ...
    'PORT-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["portToken"].mint,
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey('EbaYgE81iPz4gYsR1hCcYKP7Lk9Mg9PC844Uy7aGFTRJ'),
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["portToken"].mint,
    ...
    'ABR-USDC': {
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey('GtuwpHqeZUpnAN59fXUR6bdh2JA8xFzenjRo4UhCU5Hz'),
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["abrToken"].mint,
    ...
    'SAMO-USDC': {
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["samoToken"].mint,
    ...
    //     programId: lyfOrcaProgramId,
    //     tknMint0: tokens["solToken"].mint,
    //     tknMint1: tokens["fttToken"].mint,
    //
    //     strategyAccount: new PublicKey('45qDbYd7wdcFSaC159qezC6re8iKPtdHywctiXL4ZS2w'),
    //     strategyAuthority: new PublicKey('FwSc6VSLFVAmjYtfmiXaof8Jz2CY3QHBXeGpCWD4xv24'),
    //     strategyFarmInfo: new PublicKey('6R9yjnFqCntgYivHhJgbupwHb4b3HRpRZYE3Mx73He7k'),
    //     strategyTknAccount0: new PublicKey('Ez98EyqLzDXXzeRWzND3Ff6MNncPLXf4nFf1G9HTKJR7'),
    //     strategyTknAccount1: new PublicKey('3rqbkYShf4spqzZR9ahwFjDJRcsxSSH7mGpTQKgqgUjN'),
    //     strategyLpTknAccount: new PublicKey('7PtFLUzxQ5PtB6o4Qq3URmbjLBkG9NxUxqsGgRSnJfuC'),
    //     strategyRewardTknAccount: new PublicKey('2qec1ZFWJwvkQ5FAhWagppDBJ5rhomH2grGVijXe7fKN'),
    //     strategyFarmTknAccount: new PublicKey('2VXnmqnPejmTCsGbMSqFywiboH1LG6aKerf1wLD1DBku'),
    //     strategyBorrowCreditAccount0: new PublicKey('CUhNg8okXsknr95Ma3SUvtfbQSUpjikS2iWFk7v8iE9p'),
    //     strategyBorrowCreditAccount1: new PublicKey('LvCoJMvGrvEZQvhQ9aZ5W84vufvw9Z6hfk1sszC8QWC'),
    //
    //     doubleDipStrategyFarmTknAccount: undefined,
    //     doubleDipStrategyRewardTknAccount: undefined,
    //     doubleDipStrategyFarmInfo: undefined,
    //
    //     strategyRewardsSwapTargetAccount: new PublicKey('Ez98EyqLzDXXzeRWzND3Ff6MNncPLXf4nFf1G9HTKJR7'),
    //     strategyDoubleDipRewardsSwapTargetAccount: undefined,
    //
    //     lendingPoolConfig: {
    //         programId: new PublicKey("FC81tbGt6JWRXidaWYFXxGnTk4VgobhJHATvTRVMqgWj"),
    ...
    //             lendingPoolFeeAccount: new PublicKey('AoUSWz4pbLDzbkgUVFo3bHXaGTm5WJndzr7nXH1ad32b'),
    ...
    //     ammInfo: {
    //         swapProgramId: Orca_Swap_ProgramId,
    //         swapPoolId: new PublicKey("68Bg6yQxWm3mrUYk3XzMiF5ycE41HwPhyEdaB1cp6wuo"),
    //         swapPoolAuthority: new PublicKey("BpshqwEmPXmJwJfFgTFafmXoHN8Lc7SouvFsh6jyYQAm"),
    //         lpMint: new PublicKey("EsYaDKJCmcJtJHFuJYwQZwqohvVMCrFzcg8yo3i328No"),
    //         lpDecimals: 6,
    //         swapFeeAccount: new PublicKey("FWBCbjZnypLKz7uHGJXpBAEez2FurQXi9J3js7ZT1xDe"),
    //         swapTknVault0: new PublicKey("BbsiNbFfJsRDwqF4JaiJ6sKecNuY4eWmEaDHcY6h6HuD"),
    //         swapTknVault1: new PublicKey("3eVE92aEAsLYcBACXNu1yxoHVfTM8e8vmQC2zSApGRJX"),
    //
    //         rewardsSwapPoolId: new PublicKey("2ZnVuidTHpi5WWKUwFXauYGhvdT9jRKYv5MDahtbwtYr"),
    //         rewardsSwapPoolAuthority: new PublicKey("2PH1quJj9MHQXATCmNZ6qQ2gZqM8R236DpKaz99ggVpm"),
    //         rewardsTargetlpMint: new PublicKey("2uVjAuRXavpM6h1scGQaxqb6HVaNRn6T2X7HHXTabz25"),
    ...
    //         stakePoolRewardsMint: tokens["orcaToken"].mint,
    //
    //         stakePoolFarmInfo: new PublicKey("GzZE2CEemaTGNtRSYs9sArAJFuJi5kwsPJFyz5puYhsj"),
    //         stakePoolAuthority: new PublicKey("BnxXHRehbcfUnbiNQzLqHUmVj3GWcJKqAHJtqKoqAqzk"),
    //         stakePoolFarmTknMint: new PublicKey("9r9BcPwCon96P5Y6JSdRAog7Uknz9p9GrnuHm4VzuB9k"),
    //         stakePoolRewardsTknVault: new PublicKey("4z912LBUvbb2rcqUgEKQ9tArmakzpc3p71RhM9pMR612"),
    //         stakePoolLpVault: new PublicKey("4tUvhiYuoV7PG3kRnKYaFBXZn2NuHwXF5XwwZdwcMrJX"),
    //
    //         doubleDipPool: undefined
    //     },
    // },
    ...
    'SLND-USDC':  {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["slndToken"].mint,
        ...
        lendingPoolConfig: {
            ...
            "1":{
                ...
                lendingPoolFeeAccount: new PublicKey('AtmGFyH8vDoGNGMcLcSKBLcC29CRbLcZJnSFeDCEo4Lb'),
    ...
    //
    //     strategyAccount: new PublicKey('3JdKjRLKfVAX8Yf9N9cqdfCAGEUMXjUoroFWnZG4UuHb'),
    //     strategyAuthority: new PublicKey('61hzut3a4ANzDUGMXAo24dAxwGA95ALG26PrVgzWzVvr'),
    //     strategyFarmInfo: new PublicKey('8zD8RJURjAQmzxkRfMYpFrgdF5pFrAQ1NKkkTMEaEjqV'),
    //     strategyTknAccount0: new PublicKey('CuupWK7PxN7GbHretXrjDQPPS7gBLnaJLqQhhUqhdyKB'),
    //     strategyTknAccount1: new PublicKey('DECDAtuQAAEg539U7nxM3Um48K4Za4hMEa7jnxGQ2XNe'),
    //     strategyLpTknAccount: new PublicKey('3sNddbTWwbrzefvFEsiSad9FCZ7F975MMH3Bz98yDvMg'),
    //     strategyRewardTknAccount: new PublicKey('DNFaqzkxobSCbLX4vNQLE3Vnsdr1Q9ZTdXnEaeF3Jmmr'),
    //     strategyFarmTknAccount: new PublicKey('5cbHRxjQk9pW22ge4aqonBLAugozApwiEtkerCtbVNUt'),
    //     strategyBorrowCreditAccount0: new PublicKey('CD3kvGNnLZ7cGSUwX3dkh1RsdSZ9BND1hcvBrWE99LUn'),
    //     strategyBorrowCreditAccount1: new PublicKey('FauLNDmEaYm4DqcyKrqiLNdz2i8VcYh6Bq6YRBVtJ4jf'),
    //     doubleDipStrategyFarmTknAccount: new PublicKey('A68kdPs2oUNBMCp3ZvzC4nuj6Tv8MELVbnZDhNsE9V3Z'),
    //     doubleDipStrategyRewardTknAccount: new PublicKey('DECDAtuQAAEg539U7nxM3Um48K4Za4hMEa7jnxGQ2XNe'),
    //     doubleDipStrategyFarmInfo: new PublicKey('J4wMStFp9SqjQtm8yxEE71smbkFjzxu4TMmgeZptkz93'),
    //
    //     strategyRewardsSwapTargetAccount: new PublicKey('CuupWK7PxN7GbHretXrjDQPPS7gBLnaJLqQhhUqhdyKB'),
    //     strategyDoubleDipRewardsSwapTargetAccount: undefined,
    //
    //     lendingPoolConfig: {
    //         programId: new PublicKey("FC81tbGt6JWRXidaWYFXxGnTk4VgobhJHATvTRVMqgWj"),
    ...
    //     ammInfo: {
    //         swapProgramId: Orca_Swap_ProgramId,
    //         swapPoolId: new PublicKey("Dzp3ZWyUZGXZYWfodXdLdXfiW7gwVZBdWBwQ28eB6cTH"),
    //         swapPoolAuthority: new PublicKey("3HJw5YCXr69DzUcLSif4BicrMrXjC2jrEMpjQhQ3AwmB"),
    //         lpMint: new PublicKey("5MvQHx8eftU39JTucFsT315JFnQASuDQg3FqxTw7xcvN"),
    //         lpDecimals: 6,
    //         swapFeeAccount: new PublicKey("J8tqP1N2fEgMTGhX2PTgRyj5ZFsFWsXneJpXyRjekKWA"),
    //         swapTknVault0: new PublicKey("EVymxW4gFtxw7qjMYGFq4EupxHc1RteffwETa5MKTDPR"),
    //         swapTknVault1: new PublicKey("DxGfntMLqAjtB287GkPPcfotUGcWdhtpzR6KukdBo39H"),
    //
    //         rewardsSwapPoolId: new PublicKey("2p7nYbtPBgtmY69NsE8DAW6szpRJn7tQvDnqvoEWQvjY"),
    //         rewardsSwapPoolAuthority: new PublicKey("3fr1AhdiAmWLeNrS24CMoAu9pPgbzVhwLtJ6QUPmw2ob"),
    //         rewardsTargetlpMint: new PublicKey("n8Mpu28RjeYD7oUX3LG1tPxzhRZh3YYLRSHcHRdS3Zx"),
    ...
    //         stakePoolRewardsMint: tokens["orcaToken"].mint,
    //
    //         stakePoolFarmInfo: new PublicKey("2SxKGe1PEKWQC6m5Q1jUnXJuZBVXyUC37ffCPop38iiA"),
    //         stakePoolAuthority: new PublicKey("5aP8gmHp6bKujg5WaGA1yca8WcyY3gPm8oTTW5Am3hZH"),
    //         stakePoolFarmTknMint: new PublicKey("GWmwwMGYBG4NqYdnsYrudzBnbgDC49MkBxdzhfLA9kVY"),
    //         stakePoolRewardsTknVault: new PublicKey("7RVMH5URhzcFNdx4TQ5ThFgGTyrkpYxWn3AHi22Vz4ae"),
    //         stakePoolLpVault: new PublicKey("8h7Jkd8qivGhdCdMM29SPyqNmmXC1rxTzAzZtmBficZw"),
    //
    //         doubleDipPool: {
    //             rewardTknMint: tokens.SONAR.mint,
    //             doubleDipStakePoolFarmInfo: new PublicKey("E3hyqjh9R7UWMwkMSxYHws4qdnpMSzXwkuJfVcEfmJwb"),
    //             doubleDipStakePoolAuthority: new PublicKey("33JTiXLnaqkrGMeVTRCN2kwYTCwCmdV7GVDTbfjTWXeE"),
    //             doubleDipStakePoolFarmTknMint: new PublicKey("9tpC9vawMtim6q3MaQHfPPwFnnErh58qXhdqczS2p7sd"),
    //             doubleDipStakePoolRewardsTknVault: new PublicKey("DCWY4YZb1K54ggkEd97KzvDLaEYhM6izyi4jVyNc4BBn"),
    //             doubleDipStakePoolFarmTknVault: new PublicKey("BpPJjqrRKt8NerJ7ZCB1yLu35L5QrL5JS3mzBBkQT7dP"),
    //             doubleDipRewardsSwapPool: undefined
    //         }
    //     },
    // },
    ...
    //     ammInfo: {
    //         swapProgramId: Orca_Swap_ProgramId,
    //         swapPoolId: new PublicKey("B32UuhPSp6srSBbRTh4qZNjkegsehY9qXTwQgnPWYMZy"),
    //         swapPoolAuthority: new PublicKey("EtwQJxu8wih29vMpdTa74K9W9tgtL4LT6hbWBkhHwvU5"),
    //         lpMint: new PublicKey("Eswigpwm3xsipkTqahGi2PEJsJcULQBwZgxhQpr6yBEa"),
    //         lpDecimals: 6,
    //         swapFeeAccount: new PublicKey("74b9j23njRpt3PYPxoze2XS29ZgGmucziLB7WrsDpBdD"),
    //         swapTknVault0: new PublicKey("Fb3XpEJgghTURUGd1wphWr93ruX5egnesfdZtjWCxJFy"),
    //         swapTknVault1: new PublicKey("CeSEpgqc3zV8xDr7Q6PiwJju6a6e92wpAv7Kg6QyFfQB"),
    //
    ...
    //         //   baseTokenDecimals: 6,
    //         stakePoolFarmInfo: new PublicKey("6eW2skHuzMxxPZjzE7x5fxtn3ZZ1Ak2SawrMH9T5KANp"),
    //         stakePoolAuthority: new PublicKey("2BthDCb3r4X7CchJuC1exZHudpLUpkb2x6K7Rdz5E9wU"),
    //         stakePoolFarmTknMint: new PublicKey("3kT3oYuS1rCfhmqfgy6EKcbZdaJimaVEjoy25QiuEaoj"),
    //         stakePoolRewardsTknVault: new PublicKey("HHVfVrJWqRr8cRtvAwbVQNeuWiwxAPN76yD486cbBN9q"),
    //         stakePoolLpVault: new PublicKey("DyYYtdJYdZLTgPqEn6VoTtok3uLt662qq8hCCZzztRz2"),
    //
    //         doubleDipPool:  {
    ...
    'stSOL-USDC': {
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["wLDO"].mint,
    ...
    'SHDW-USDC': {
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["SHDW"].mint,
    ...
    'BASIS-USDC': {
        ...
        ammInfo: {
            ...
            doubleDipPool: {
                rewardTknMint: tokens["BASIS"].mint,
    ...
    'UST-USDC':  {
        ...
        ammInfo: {
            ...
            doubleDipPool:  {
                rewardTknMint: tokens["LUNA"].mint,
                ...
                doubleDipRewardsSwapPool: {
                    ...
                    rewardsSwapPoolRewardsVault: new PublicKey("97aVH3M9cjZmfA5HVu9iJ9AnE41inBG1Sxqj8UQhR2jo"), //new PublicKey("Av3RXECkvPCehJTJNbkWmUj3LmP63c4btzMYjbcYLkpm"),
                    rewardsSwapPoolTargetVault: new PublicKey("Av3RXECkvPCehJTJNbkWmUj3LmP63c4btzMYjbcYLkpm"),//,new PublicKey("97aVH3M9cjZmfA5HVu9iJ9AnE41inBG1Sxqj8UQhR2jo"),
                }
            }
        },
    },
    ...
    'stSOL-USDT': {
        ...
        lendingPoolConfig: {
            ...
            "0": {
                tknMint: tokens["usdtToken"].mint, // usdt
                lendingPoolInfoAccount: new PublicKey("EyqWUeme2B1dhuwJvJVi2coYPcGWmWrakcpsSFeikrhb"),
                lendingPoolTknAccount: new PublicKey("Acx3Ky9pk8CyYftA9HYF31EbVhBDi21EqJsFtMW2XxXW"),
                lendingPoolFeeAccount: new PublicKey("8f92LjiwrtVZHmL3TW1vbg3pG2C3B7LLQ9hRS4j13caX"),
                lendingPoolShareMint: new PublicKey("8TtsTZQ6mU4YSW5jw4sDjSDEG1CW8QLpK7C9g5TVgBvn"),
    ...
    'SLC-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["SLC"].mint,

        strategyAccount: new PublicKey('4EqUuhJ4GKvoGDpLiJoA4GzNEP5BN289TdWNFyePUsUz'),
        strategyAuthority: new PublicKey('6uLVME9zCSfQCHsFMMonAyt3rU5x2iwETe8sdxBE9cEG'),
        strategyFarmInfo: new PublicKey('3feXrVkLd81YofYbK4RtFLAZdqoJWuDuc4eckNjLvTnh'),
        strategyFeeAccount: new PublicKey('G9ucCcDxxd7MZsBic1pmE1kHKYxgqyHKqJ3WcKmZtHhM'),
        strategyTknAccount0: new PublicKey('4DG3aqgY4jXcMgXqDSEdmty58xJnuGCHejY7mxgg7cKi'),
        strategyTknAccount1: new PublicKey('4XWeXjYBUMjmhnvTMXveuXizCf3cNptL18mvxpVmeywm'),
        strategyLpTknAccount: new PublicKey('L4t4q9No87cbsih5S2buBRcewY4QncaHHqzduEUC4x7'),
        strategyRewardTknAccount: new PublicKey('Fq1ep7JU6TDBYTZr9nqwqyqvwNt5fpGjZW2hizYYtUuh'),
        strategyFarmTknAccount: new PublicKey('3hb7NhkBP4JorsS7uZxdNSyBhTLnWLfSmvcyHQjSEDuN'),
        strategyBorrowCreditAccount0: new PublicKey('GWJFzyQ5ieex6zVQQ5rpvu4Fr2sFfVNGpZFmss7wLT2y'),
        strategyBorrowCreditAccount1: new PublicKey('8AvLM9W19PXojPWAZtbEXi9F9VLHoRshZyxmtwkJm9ho'),

        doubleDipStrategyFarmTknAccount: new PublicKey('HXF1DwXXqm7TZ1ortjJjFESgxM2QLmdv13pcP4KM5brR'),
        doubleDipStrategyRewardTknAccount: new PublicKey('4XWeXjYBUMjmhnvTMXveuXizCf3cNptL18mvxpVmeywm'),
        doubleDipStrategyFarmInfo: new PublicKey('TYUnYb5nQTLHiUaSQVszyzYBdDD8PKuPqh1sNbwqzpK'),

        strategyRewardsSwapTargetAccount: new PublicKey('4DG3aqgY4jXcMgXqDSEdmty58xJnuGCHejY7mxgg7cKi'),
        strategyDoubleDipRewardsSwapTargetAccount: undefined,
        ...
        lendingPoolConfig: {
            ...
            "1":{
                tknMint: tokens["SLC"].mint,
                lendingPoolInfoAccount: new PublicKey('24fodm8gsTXDEvmt8pYuLvHGpoPcqhRNrPZKRpDB8ZjJ'),
                lendingPoolTknAccount: new PublicKey('43cCG6nehzkonEMnv3hB9rs47eUXE5UsPe9fKnLnE5ii'),
                lendingPoolShareMint: new PublicKey('CsToPJCNi6h537XuCvSwRrzB2MhEBmdjrjfwGW5b8wc2'),
                lendingPoolShareAccount: new PublicKey('HKTL2SbYpjqFm8mq6QgoA1QX3pJsqJGohYuGyNJ1cBMo'),
                lendingPoolCreditMint: new PublicKey('FFagqVSuSzMbroqDdP8HA2w2YpnBHiQkuzPhv5845eBP'),
                lendingPoolCreditAccount: new PublicKey('HF68ohm3q2P5rRKEbreNyjRDNMFjVX5uE6a2mVagromm'),
                lendingPoolFeeAccount: new PublicKey('Jvdv3Hz21gQzL5TL4cuWA8hqXteVVpzC2Fm8yPN7gdB'),
            }
        },

        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("ByfDbpLVNVQHzU6E5dmLE1kcAKWAYRr9LPSGcVxxSRFF"),
            swapPoolAuthority: new PublicKey("7G6i4eQxiJvXg7hPn5kMrso8AHQNsdfPZZdJM3NNJuYz"),
            lpMint: new PublicKey("E5kSBqTDxFLbLNQaVVtPtnhEYVLMCK2fVSEKoMKL98qR"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("CtBP4cFDLzm3KQCQRKXwwsMgYG9f6hbwuUswUZBzYvvY"),
            swapTknVault0: new PublicKey("CHuUSo3EMCqtGWvUGRj4crmDzV5YKdYvqrhHSEitAP8V"),
            swapTknVault1: new PublicKey("EnvNSVK9JRQ5jmsz7nvbhYmR3MHSeMvB8Mf1e4VwoyRe"),
            ...
            stakePoolFarmInfo: new PublicKey("AgscvT8HJ4uqznp4SeYMgKf9qUjTrQL7AzU6mjcqpPCB"),
            stakePoolAuthority: new PublicKey("6C5VCVndZ8oCaM26dxH4ketBT6r2ajV1rcb9Cz5R74f7"),
            stakePoolFarmTknMint: new PublicKey("X8GnAvxq942xXjNzqYPFQQ9JstJQNEA81uPeNoQpgrN"),
            stakePoolRewardsTknVault: new PublicKey("BoSwTuqdrSAj789KvLhYfKCxxwtqVWY4EdXLrZn6tDRq"),
            stakePoolLpVault: new PublicKey("HSNukL7uFW1axv4x7PDTFhwLhQRD1fGFMFjtyMFuRNzb"),

            doubleDipPool: {
                rewardTknMint: tokens["SLC"].mint,
                doubleDipStakePoolFarmInfo: new PublicKey("DdYbYsTgpp3pBdGhN9sSdgRJs4ijKZQuDqzqKz6qmScs"),
                doubleDipStakePoolAuthority: new PublicKey("6PExnobESJzgVf6kxnmEPbBcKgk7oPoVoKoUL6fXG1QE"),
                doubleDipStakePoolFarmTknMint: new PublicKey("6VWtaecVXHuorMwVrZ4GAnYC3T5MG1YdQLYNPGyWzQHh"),
                doubleDipStakePoolRewardsTknVault: new PublicKey("6z2TSEQNEKoifzdrc58sxKGMgcVXfbH7MyY5mHqDTe5e"),
                doubleDipStakePoolFarmTknVault: new PublicKey("8j4X8HHGh9G3Ju6fCrpkKUGfPVs4AieaPX9PefESBPgX"),
                doubleDipRewardsSwapPool: undefined
            }
        },
    },
    ...
    'MEAN-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["MEAN"].mint,

        strategyAccount: new PublicKey('BZCv2UyMuDsKMaFuXitLxmGkSwwaQFVEqxRxYj5Ro3gn'),
        strategyAuthority: new PublicKey('BQff27Exv5AUuJotJ6USiqYmpVoL1QjwBK8NX1ScHQCD'),
        strategyFarmInfo: new PublicKey('57Kwtjh6cCyuUZ4sovyEd7xZCTKaABx9PL2vZ7Wych5t'),
        strategyFeeAccount: new PublicKey('7csFS4GCeX6zBRVgWgnpu2mmPTz3rGR2JLpgzy6bQveo'),
        strategyTknAccount0: new PublicKey('FhC789zEr5HMMWb8Rkxp5F7YWxTw1fiGujUrdot2LJqa'),
        strategyTknAccount1: new PublicKey('9cXCZ3JS7ndsQJY5vMk2yHm9rEP6FhoYu4R7bRR6trwB'),
        strategyLpTknAccount: new PublicKey('594pqa8ViuJZtNMfXTFNSzTFfBRcqCxdF23xvikeWrnx'),
        strategyRewardTknAccount: new PublicKey('yuCyvekZBqGserpMSYhRa5Kr47813WHWz2eCUSY6uzi'),
        strategyFarmTknAccount: new PublicKey('2hxvDw4oSUc5xMQeDh631Kagcvpek7tu9LHDJuofYiYD'),
        strategyBorrowCreditAccount0: new PublicKey('7nDV18DNk6vRxNqXbsx3FrhKhJo3N4Y28JjnwFoQg1eZ'),
        strategyBorrowCreditAccount1: new PublicKey('tjmiCtYtMfZXkptKwnXKRvtCJ1bM2gx5BwjSmbHYNYB'),

        doubleDipStrategyFarmTknAccount: new PublicKey('GUUDcZCK5dngsMKAUodnbpRqbuud7cJMMGxt1Cy7K3kq'),
        doubleDipStrategyRewardTknAccount: new PublicKey('9cXCZ3JS7ndsQJY5vMk2yHm9rEP6FhoYu4R7bRR6trwB'),
        doubleDipStrategyFarmInfo: new PublicKey('ALMZ2TEqamG8ZLdhdHQUWx8Teg4qeP6GtzfFPhiPDANf'),

        strategyRewardsSwapTargetAccount: new PublicKey('FhC789zEr5HMMWb8Rkxp5F7YWxTw1fiGujUrdot2LJqa'),
        strategyDoubleDipRewardsSwapTargetAccount: undefined,
        ...
        lendingPoolConfig: {
            ...
            "1":{
                tknMint: tokens["MEAN"].mint,
                lendingPoolInfoAccount: new PublicKey('HpKYkXReCMxFZBZvaqb7iwQ767dsYZhQSMCxCKT3A2ZX'),
                lendingPoolTknAccount: new PublicKey('8kvvQYriQCbRtQE1JFhViXkRzeKofNcFZpSGMajjxx5W'),
                lendingPoolShareMint: new PublicKey('72KR5hEAXNv1ARvhrZgZLgj3HLZ14bD6LhYvdAfNkjAi'),
                lendingPoolShareAccount: new PublicKey('5LLAFNqsgzcZbpSPWvCD5ft224mZr7AAi8HFcaKLAukr'),
                lendingPoolCreditMint: new PublicKey('FEuvr1f6Xect29eVRwUcNTFX6rNVXQ4QyqRf4NoB4D24'),
                lendingPoolCreditAccount: new PublicKey('7mwJU2fFNHeKbrXm5Cug2TY9TKpyNJ3ga5Xdx6pnjs8w'),
                lendingPoolFeeAccount: new PublicKey('Ess1nujpvv6kATbtgtDahtdErAZAx4R6375AmRNwVHar'),
            }
        },

        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("4jhCSYuGkLCiB8uvCaS34QCtPycBjayxEk27YCartTuW"),
            swapPoolAuthority: new PublicKey("Fawkj9g4s1M26uZDF6QczEviyib2Ge3FaPdCG9TJLYcm"),
            lpMint: new PublicKey("F5BTnwuMA6rxftTdbZ33VWKr2wrr6DuQHnd4guKmPSYQ"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("EqhWQbxsa36o7YSrCNvJTV1yoTRTWxCiLKcG9pzafprc"),
            swapTknVault0: new PublicKey("13PtHDhQzswoFWg8Gr4yVrTmUEW4CWxeKFkLVERCmypB"),
            swapTknVault1: new PublicKey("5KSCuA99i7PSF6KvvbvV5hDveGse7isqF6e7tFXPeMyn"),
            ...
            stakePoolFarmInfo: new PublicKey("4ZqD3uYerAhUrVCPSKV15JT7ToR4EW1TwK6HHckAZNio"),
            stakePoolAuthority: new PublicKey("AAhgxLukiP4ksVDrHottBKmRkyQr8VAuJ62wvkNNoLp6"),
            stakePoolFarmTknMint: new PublicKey("3h2VBX8533NB8eEH8rPXMdayodFDbgTHpbav6JqLZAQq"),
            stakePoolRewardsTknVault: new PublicKey("6t4aE3jJw93aGvkUuQNJqCTrX1hRJ6oucWJukbX7n8nP"),
            stakePoolLpVault: new PublicKey("9bCrsMBW23sgNaQ6H3KxjE2pvu5bozQyrDCGrMVxqbth"),

            doubleDipPool: {
                rewardTknMint: tokens["MEAN"].mint,
                doubleDipStakePoolFarmInfo: new PublicKey("9TQ4HQXymNLVKEMve5peFXst5VPDXX1oZ8VTVuQeG7W7"),
                doubleDipStakePoolAuthority: new PublicKey("AoQQM1PxeK2x9gWw597W3tvg2JY9N3fJdijsYmge85iB"),
                doubleDipStakePoolFarmTknMint: new PublicKey("FaFGyRihhc8XUqWXNrVAd6gjRsyJ98mogonH4EN8WUPb"),
                doubleDipStakePoolRewardsTknVault: new PublicKey("61MKWzucEtuuJyyupe6cR5UgPxnRXiWaWQPJPjdERGLP"),
                doubleDipStakePoolFarmTknVault: new PublicKey("48LQ7HVAyhgqyMoyGbbBFbfDeLwBKvRNfPd14yURee6F"),
                doubleDipRewardsSwapPool: undefined
            }
        },
    },
    ...
    'ORCA-USDT': {
        ...
        strategyAccount: new PublicKey('G95N6NV68KBCdSw22N1DeR3UqRcfwBqYqbF6iV1FejaS'),
        strategyAuthority: new PublicKey('FuMwHDNxPH7uRtmcD5eWfointfL8j8W4XERxn2UYhK8a'),
        strategyFarmInfo: new PublicKey('2eg2BpwpL28CMwF9UcXy34EPo1HvHkPKDrKCnPoqWB9h'),
        strategyFeeAccount: new PublicKey('2JLX6s8Wi7ivRNczdT3t8AHXds4oPAD7DVmB2EjfbDEn'),
        strategyTknAccount0: new PublicKey('6xSfVkmAwEKn1faPtL4Q5oRqbHP7kp1Gax1ipMHoY6KY'),
        strategyTknAccount1: new PublicKey('41fNLo3qcT8oEvuMfyMADfQKzP1FdQmePV5JunD9VuqU'),
        strategyLpTknAccount: new PublicKey('DXgFtybJZgejJ8iCkMP2eW6kTa9sARLMfT1BybGCBGmS'),
        strategyRewardTknAccount: new PublicKey('41fNLo3qcT8oEvuMfyMADfQKzP1FdQmePV5JunD9VuqU'),
        strategyFarmTknAccount: new PublicKey('DxVvfuiErAQnct928uB8uTMpVVEvsmX9ErynGvkv5R1J'),
        strategyBorrowCreditAccount0: new PublicKey('Bb5dJuMX8oSd5bYSndtV3iRgtXPSkHwNY7uUzBvBbhYs'),
        strategyBorrowCreditAccount1: new PublicKey('J24zAWnRi2xKPGcqLnC8E8FPs9Cy7gXsrhmuPSGyp4ev'),

        doubleDipStrategyFarmTknAccount: undefined,
        doubleDipStrategyRewardTknAccount: undefined,
        doubleDipStrategyFarmInfo: undefined,

        strategyRewardsSwapTargetAccount: new PublicKey('6xSfVkmAwEKn1faPtL4Q5oRqbHP7kp1Gax1ipMHoY6KY'),
        strategyDoubleDipRewardsSwapTargetAccount: undefined,
        ...
        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("4YnaUPeZ2fYqpoLrCyprSai8LaDWZxmgb6cGfNHJmyP6"),
            swapPoolAuthority: new PublicKey("35d4qNQiMtNV9Yb2kqk4tSd5M1yEqozWSQaYtjGHCA7b"),
            lpMint: new PublicKey("Gx4PoxenyQwhGGnKagAT35iVg4im1iKhJxDWqVhgu6tk"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("ABuGLBFTwcbLsqNsiCpZsFuNmHYwHEzfQR9SNpr4y3bP"),
            swapTknVault0: new PublicKey("Fy4AwXwAwitVdFwgWBdYkqRVv8QjigU86ssL6rqzgp8S"),
            swapTknVault1: new PublicKey("D91z1TewbTQ3AVc9RThtTjiMVRqr94CP73XrsbHEhej8"),
            ...
            stakePoolFarmInfo: new PublicKey("4SNMBiDGjDSZnyQFqSodJTTmRqEkisBWciXZ4hGbDujc"),
            stakePoolAuthority: new PublicKey("8KcPN1jmuSKExCYFrMj6YLjHoWFmVTU8LB9cotf1eTKB"),
            stakePoolFarmTknMint: new PublicKey("C2YSdSesufbMVWtKXSZGhc12f6UL2j3WDe9VT6rRbmA8"),
            stakePoolRewardsTknVault: new PublicKey("EGpzGNcANPGFGogqARxS7hjN7zjAPHxYgFEBguLNhLTP"),
            stakePoolLpVault: new PublicKey("Aj91YpocMRG6uc6xCj6okX82FpFuBMbmKgwuP9XxY4dD"),
    ...
    'ORCA-whETH': {
        ...
        strategyAccount: new PublicKey('85cU4CdMUdHVck86P1ivQt5KW5QBi9mvjNswHqe75sXS'),
        strategyAuthority: new PublicKey('87Bsh4qVMzMVszR4uwr741rJGmrgEACsTzAQUirg4xHZ'),
        strategyFarmInfo: new PublicKey('2FNWMrLZvyoGJXbfdmjTdmW8VVrURVbKvBppXyLViqhm'),
        strategyFeeAccount: new PublicKey('B8vQ3FpzrREmFj7kaGAfyctmxh4AvaeGSC98qQWf2Y8P'),
        strategyTknAccount0: new PublicKey('3LWFP236h3NzcDiHwTLrT1taWhu8xM2GfbB6oMu5hDmN'),
        strategyTknAccount1: new PublicKey('7vLrnfw1nnVvDqzvvWSWyjnTbuoRSH1kNiddWfUwcWVm'),
        strategyLpTknAccount: new PublicKey('7FssV3EfoNSppdKcxjG7aZYwbTW5LQBqtDrBriAoYMUb'),
        strategyRewardTknAccount: new PublicKey('7vLrnfw1nnVvDqzvvWSWyjnTbuoRSH1kNiddWfUwcWVm'),
        strategyFarmTknAccount: new PublicKey('BdLPa9YKqiYbar1m6UMSyESMPNXEmZuKi3b2i6RUPJL8'),
        strategyBorrowCreditAccount0: new PublicKey('4jFL3kTs5MJcpeKQJ9pSmxCBZAcjsbnBJXEjnY9z1TV4'),
        strategyBorrowCreditAccount1: new PublicKey('FmfSK4RCshzuCVBmgkn6zz3gq8WRNYqwhMT62NhPDqZp'),

        doubleDipStrategyFarmTknAccount: undefined,
        doubleDipStrategyRewardTknAccount: undefined,
        doubleDipStrategyFarmInfo: undefined,

        strategyRewardsSwapTargetAccount: new PublicKey('3LWFP236h3NzcDiHwTLrT1taWhu8xM2GfbB6oMu5hDmN'),
        strategyDoubleDipRewardsSwapTargetAccount: undefined,
        ...
        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("D67u6UEuFp9Q4Fu2gnu5thxBoVj2eRgDDDirdWsMVsgm"),
            swapPoolAuthority: new PublicKey("4kwchkCnCaZPkBdnk85j9bJ9F1P883rwjbvsXGV7H5rM"),
            lpMint: new PublicKey("GsfyYHkSgC3Ta6aWR9MjB2sxoBrkGGeR2tAwXbpphf3"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("GdHXLai5M8FKedXUsECSzrV72nb1RTCCooFyTWT8WYmT"),
            swapTknVault0: new PublicKey("DQyhcuEvE1K9DSd51agcNLg4CDrgthnKMVhU7q6R55LV"),
            swapTknVault1: new PublicKey("EMxDw1NjdddQjPk9gCUN4iDMy8HJ5siKYMVjGbjuUCrh"),

            rewardsSwapPoolId: new PublicKey("D67u6UEuFp9Q4Fu2gnu5thxBoVj2eRgDDDirdWsMVsgm"),
            rewardsSwapPoolAuthority: new PublicKey("4kwchkCnCaZPkBdnk85j9bJ9F1P883rwjbvsXGV7H5rM"),
            rewardsTargetlpMint: new PublicKey("GsfyYHkSgC3Ta6aWR9MjB2sxoBrkGGeR2tAwXbpphf3"),
            rewardsSwapfeeAccount: new PublicKey("GdHXLai5M8FKedXUsECSzrV72nb1RTCCooFyTWT8WYmT"),
            rewardsSwapPoolRewardsVault: new PublicKey("EMxDw1NjdddQjPk9gCUN4iDMy8HJ5siKYMVjGbjuUCrh"),
            rewardsSwapPoolTargetVault: new PublicKey("DQyhcuEvE1K9DSd51agcNLg4CDrgthnKMVhU7q6R55LV"),

            stakeProgramId: Orca_Stake_ProgramId,
            stakeUserFarmInfoLayout: ORCA_USER_FARM_INFO_ACCOUNT_LAYOUT,
            stakePoolRewardsMint: tokens["orcaToken"].mint,

            stakePoolFarmInfo: new PublicKey("AgWH92f8cPAuURyqehF6A9wFgupEsnDX3VP5eHyytabA"),
            stakePoolAuthority: new PublicKey("B1pahxFpN3GX4TKsw7fEDLw5MuuzmHNUbVcPZ6bp7KBM"),
            stakePoolFarmTknMint: new PublicKey("A7EAHvFEWzW8qSTFNLrEHN894GAZWZesNiebttEwtUGJ"),
            stakePoolRewardsTknVault: new PublicKey("DoaerVHonB3FYpzKtqADug9UtrPLzgY1gbzZm6cRuymi"),
            stakePoolLpVault: new PublicKey("CYSwKVGEaPazRXUcCo2Ve9wyovK44E9ftLNSsvVqRuf1"),
    ...
    'GST-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["GST"].mint,

        strategyAccount: new PublicKey('8vGrYP8TCpSyCU3FM2UgBwqeUhNx6yveE7pEM8vteDwR'),
        strategyAuthority: new PublicKey('8cd1w6m3cYDH1SazhdSyCjNtqD3RERMb9yCF9cKvL1Hj'),
        strategyFarmInfo: new PublicKey('2cx2i5sQFHSAEv5X6PJTiWVZz8e2ZsXBiAo71BanbtK8'),
        strategyFeeAccount: new PublicKey('Hk2WcE4po5TSjvo9GNPhxHfyVTRjKze5QfbQLw1UYJ71'),
        strategyTknAccount0: new PublicKey('2TNJX1U3DV333QgzqDpvS9s53h7ZMZTE9FLSYEbaMp2n'),
        strategyTknAccount1: new PublicKey('2e8LpUqqN5qptzRdQeAhiDnUxiG5PaWu4k4rXg3gN7GR'),
        strategyLpTknAccount: new PublicKey('3ofNvLGB9mM1edvM6ikeTnjFK4AmGjbiV35oiPTtvymX'),
        strategyRewardTknAccount: new PublicKey('J7JQsm6JddyQH26FWXuUohPyH9KzVhog7HhPJwKVeW8y'),
        strategyFarmTknAccount: new PublicKey('CXwAxWW5u5PvFVKBSpcrCK7kDGQ9oikp7GmpkTsKqCbW'),
        strategyBorrowCreditAccount0: new PublicKey('EpaYEiaukpB6RaXvdRpNLLBCg9VWaH96YVg3UvBkZomC'),
        strategyBorrowCreditAccount1: new PublicKey('3yuiRk1NhaJHTwNkh5VwpjVs1JbgjBons4d9udg3cTWL'),
        doubleDipStrategyFarmTknAccount: undefined,
        doubleDipStrategyRewardTknAccount: undefined,
        doubleDipStrategyFarmInfo: undefined,

        strategyRewardsSwapTargetAccount: new PublicKey('2TNJX1U3DV333QgzqDpvS9s53h7ZMZTE9FLSYEbaMp2n'),
        ...
        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("87E4KtN7F4LivKhjqXaoQAvS3a8HnM4DnMUrbMrkVvXY"),
            swapPoolAuthority: new PublicKey("CwwMfXPXfRT5H5JUatpBctASRGhKW2SqLWWGU3eX5Zgo"),
            lpMint: new PublicKey("E6FUnQHGHJVJg7oExVr5Moeaj1QpdpZQF5odYjHXWPZb"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("BynpQprCNjcY2KHeffDKzquyKWvJxikty3donrMT4ZPU"),
            swapTknVault0: new PublicKey("7LFnr5YgUyEgPMCLGNQ9N7wM5MFRNqCuRawLZTe5q4c7"),
            swapTknVault1: new PublicKey("9r39vqrJuubgafaJ5aQyDWYAUQVJeyZyveBXeRqp7xev"),
            ...
            stakePoolFarmInfo: new PublicKey("44aNS8nnj4r3WWvnR1Ud929iAqn5jJ7ugVkJJvH4XuW9"),
            stakePoolAuthority: new PublicKey("DFRXY2zC2JAHK2jMzoKMwydYhfgoaCXibNrhcb87sqYD"),
            stakePoolFarmTknMint: new PublicKey("72vxFxfeSN2DRKmSQAkJCoFBNYb2WNevyaDh4v2t8TqP"),
            stakePoolRewardsTknVault: new PublicKey("9MboiCmp7Gas6nRX39oRcFge66Efkn5Ui9fz7SrQmue9"),
            stakePoolLpVault: new PublicKey("9swuhhrnLGDzXKAicByxMYBnSANJojeaaCJ3uENWuijq"),
    ...
    'GMT-USDC': {
        ...
        programId: lyfOrcaProgramId,
        tknMint0: tokens["usdcToken"].mint,
        tknMint1: tokens["GMT"].mint,

        strategyAccount: new PublicKey('ARFym9sQwHPvkAY55YMVnuXQDTwNUPXRK2j7vqAozU7Y'),
        strategyAuthority: new PublicKey('6amjzmLrimZMVafSjqV9u6XwEN7ZojLdUyVTQnDqiSgg'),
        strategyFarmInfo: new PublicKey('Da8HS7Xwqs7q4B4113uxaiMEfj5thSypuZxckGyX6i7q'),
        strategyFeeAccount: new PublicKey('327seg4NjcCfLELpKxdWrxfnaXPsPgSisv7MorQhGncn'),
        strategyTknAccount0: new PublicKey('5QHHTxQ8V9RepJbYU9m1kaa6bkLZS2D34B234LoGigo7'),
        strategyTknAccount1: new PublicKey('4AWyb6euRFojc6vTqEdpNDrG1HLoPnQQMnKAdguYVbZ2'),
        strategyLpTknAccount: new PublicKey('F1XhnAEzh5z1VPQv6AVxPWecWhcAeRdzVABiTRjGB4Zw'),
        strategyRewardTknAccount: new PublicKey('4x91BfSTaFxnabKxEFoS3z9Gv7qr5PN41Ye3dXrgUUxR'),
        strategyFarmTknAccount: new PublicKey('C9PDc7x51oVuWdXumoXiRDNmEZeZyJATyNPL2PYuwtRo'),
        strategyBorrowCreditAccount0: new PublicKey('74HhznN3R48K9QVq2gG31f8hBRSUXcD1gTCVHigbg7Wp'),
        strategyBorrowCreditAccount1: new PublicKey('2P8mxBQfLaozTeZ2HBgf87i3u8YRB7BsPariWNVroi3P'),

        doubleDipStrategyFarmTknAccount: undefined,
        doubleDipStrategyRewardTknAccount: undefined,
        doubleDipStrategyFarmInfo: undefined,

        strategyRewardsSwapTargetAccount: new PublicKey('5QHHTxQ8V9RepJbYU9m1kaa6bkLZS2D34B234LoGigo7'),
        ...
        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("46GcZFgznxUf6TpoCqJqzMpgMbbJPCAwNn8GThSt9qjC"),
            swapPoolAuthority: new PublicKey("3HGGVGTXbqT49PG3L8JQYH4jCeP5CNBG6CpJniZ434an"),
            lpMint: new PublicKey("CFxQF5kNAtbbDj298Xr47Sf4mkSyuzWpRH97hrdQ6kxi"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("3pBqsnahNsm6p14FFjtMCGfD1VCQNcUEdNEeSwTGfE2q"),
            swapTknVault0: new PublicKey("DdBTJuiAXQQ7gLVXBXNPbVEG8g1avRxiJXhH5LhBytYW"),
            swapTknVault1: new PublicKey("BTpvbpTArnekGgbXRqjfSvp7gENtHXvZCAwuUKQNYMeN"),
            rewardsSwapPoolId: new PublicKey("2p7nYbtPBgtmY69NsE8DAW6szpRJn7tQvDnqvoEWQvjY"),
            rewardsSwapPoolAuthority: new PublicKey("3fr1AhdiAmWLeNrS24CMoAu9pPgbzVhwLtJ6QUPmw2ob"),
            rewardsTargetlpMint: new PublicKey("n8Mpu28RjeYD7oUX3LG1tPxzhRZh3YYLRSHcHRdS3Zx"),
            rewardsSwapfeeAccount: new PublicKey("7CXZED4jfRp3qdHB9Py3up6v1C4UhHofFvfT6RXbJLRN"),
            ...
            stakeUserFarmInfoLayout: ORCA_USER_FARM_INFO_ACCOUNT_LAYOUT,
            stakePoolRewardsMint: tokens["orcaToken"].mint,
            stakePoolFarmInfo: new PublicKey("DbJT9UTTt8U8xAk7BtRWC3nQHxJnNmZdZydUAhJj14TZ"),
            stakePoolAuthority: new PublicKey("48T3au6xpUCz2Eeg6xgc3XJmCUTTH4qwmq1BytihxQMJ"),
            stakePoolFarmTknMint: new PublicKey("8EnEoVX1aXkzbTzhrqDQ2aVGybbPpeWZDCYEGjjw1dyG"),
            stakePoolRewardsTknVault: new PublicKey("9rc6Cyw21Kx8ofamntNVWa9v8vza7U4hGwxne764qL25"),
            stakePoolLpVault: new PublicKey("FPi9U6fLhVBggWdTwsPgByjEps6w8DiMyU5LqjLtvXnd"),
    ...
    'stSOL-SOL':  {
        ...
        strategyAccount: new PublicKey('uoWoFS7QkpsYjaUAv4GmLzLzt4wJCfFzvxDtQ35zypK'),
        strategyAuthority: new PublicKey('CBpJCP5EZdJXRww8wKxZ4aS96di6CkDTW1ZqnDkrBYuG'),
        strategyFarmInfo: new PublicKey('H2gkE5LGXYBxtwnzy12CR3hwMk8naH3jp2Zhxouo7JRw'),
        strategyFeeAccount: new PublicKey('4nWnqP3rXN9yBMVT5ZXM4n12zcMWyv8veTfHM5EQWM9N'),
        strategyTknAccount0: new PublicKey('HS4csNqrJWWpwnLg2mPArZvWFe18pmeRJRHuffhyT2T6'),
        strategyTknAccount1: new PublicKey('8oBX7xyN79BaRKAgdrJdzteLnYiHwM7YZ2n28qSE9Y9q'),
        strategyLpTknAccount: new PublicKey('84N5P2Td5yjaEuaNLH72HwGRQiok4gDQHVPStCrTZbvF'),
        strategyRewardTknAccount: new PublicKey('EGdzwdLbWPJrsWmyny5Z8hWmrD5utCVBdBoHUq6QtBXV'),
        strategyFarmTknAccount: new PublicKey('7EnhVQgk5GowJBTyqVEUSZj9x4LhcqnBEaGTLPQEVFWX'),
        strategyBorrowCreditAccount0: new PublicKey('28tgxiReMoi7VZsQqwdMPwcTUwAneNBRv6sbYHZFNJi8'),
        strategyBorrowCreditAccount1: new PublicKey('GbVC7YuNtNXXLNpLNbTa92ECnrM6SYqps6FiqCVkjkEc'),
        doubleDipStrategyFarmTknAccount: new PublicKey('D5FzAxd6KV1cag6s8cZx8DXKutZh7e35o9A9r62a2cpF'),
        doubleDipStrategyRewardTknAccount: new PublicKey('2UjbTqUKMaXy64Rde7JfgAEiD8tHXfQiqSnhZZwZ1o4f'),
        doubleDipStrategyFarmInfo: new PublicKey('5HQixSpjVuVzP1uffhaHTecUXbxsXJq4r4JHuwfiJztF'),

        strategyRewardsSwapTargetAccount: new PublicKey('HS4csNqrJWWpwnLg2mPArZvWFe18pmeRJRHuffhyT2T6'),
        strategyDoubleDipRewardsSwapTargetAccount: new PublicKey("8oBX7xyN79BaRKAgdrJdzteLnYiHwM7YZ2n28qSE9Y9q"),
        ...
        ammInfo: {
            swapProgramId: Orca_Swap_ProgramId,
            swapPoolId: new PublicKey("71zvJycCiY2JRRwKr27oiu48mFzrstCoP6riGEyCyEB2"),
            swapPoolAuthority: new PublicKey("5qpKgo2PSNSkmHGAa4oYrEZcYA3CQaFpA66nPVuP1qHX"),
            lpMint: new PublicKey("4jjQSgFx33DUb1a7pgPsi3FbtZXDQ94b6QywjNK3NtZw"),
            lpDecimals: 6,
            swapFeeAccount: new PublicKey("7nxYhYUaD7og4rYce263CCPh9pPTnGixfBtQrXE7UUvZ"),
            swapTknVault0: new PublicKey("8y8X4JuZn1MckRo5J6rirpr2Dxj1RKQshj7VzuX6dMUw"),
            swapTknVault1: new PublicKey("HQ2XUmQefvBdpN8nseBSWNP2D1crncodLL73AWnYBiSy"),
            ...
            stakePoolFarmInfo: new PublicKey("9bKvCTiVrnSzFPrd4g7Dd9SeEZvKNn3SQ7dMpuE9VKuo"),
            stakePoolAuthority: new PublicKey("JCgP2UTUcdEWmPLofpi2JxwKqrqgKAQYTp74URDGFayy"),
            stakePoolFarmTknMint: new PublicKey("7ZvhrqdnP2NrQi2YCjQNd8jKJpLDMUuZg4wP7XJPjnVX"),
            stakePoolRewardsTknVault: new PublicKey("CMVgQkiSjFNu6HMPNw4Qysd4TZbNauej7bJJ5FXna9qr"),
            stakePoolLpVault: new PublicKey("4QxRpDXEX76mqwu59c8K9ZLdjfTeVi5RKjCtrP6SrNuN"),

            doubleDipPool:  {
                rewardTknMint: tokens["wLDO"].mint,
                doubleDipStakePoolFarmInfo: new PublicKey("D7tPD1ZP46fH2jJoL8YH75aPkGQVXFJVYiX7G2NVKt3T"),
                doubleDipStakePoolAuthority: new PublicKey("CmXxxmjjapMkTRqxikzRmPVHxnWYZoFnje6ZnqxaBxEW"),
                doubleDipStakePoolFarmTknMint: new PublicKey("HaBymyP8zL1pgpnkdAn14pmTQbLQpiraYwd1uEzkReG9"),
                doubleDipStakePoolRewardsTknVault: new PublicKey("3DtQngU4Lg1GSzMotpUtS6dB4NvaaGEFRvA9KdPx2hve"),
                doubleDipStakePoolFarmTknVault: new PublicKey("EdBDRpV8S5LDTUAkQA83AXhpPeSLbWmNoUiNYds72b3y"),
